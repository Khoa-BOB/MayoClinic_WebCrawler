# Adalimumab-adbm (subcutaneous route)
...
Appropriate studies performed to date have not demonstrated geriatric-specific problems that would limit the usefulness of adalimumab-adbm injection in the elderly. However, this medicine may cause serious infections and cancer more often in the elderly, which may require caution in patients receiving this medicine.
...
- Allow 15 to 30 minutes for the syringe or pen to warm up to room temperature.
- Do not remove the needle cover on the prefilled syringe or pen while allowing the medicine to reach to room temperature. Remove it before use.
- Check the liquid in the syringe or pen. It should be clear and colorless to slightly yellow. Do not use the medicine if it is cloudy, discolored, or has particles in it.
...
1. Drugs & Supplements
2. Adalimumab-adbm (subcutaneous route) - Side effects & dosage
